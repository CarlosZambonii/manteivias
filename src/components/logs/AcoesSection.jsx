...
export default function AcoesSection({ acoesData = [], loading, search = '' }) {
  const [categoria, setCategoria] = useState("Todas as Categorias");

  const items = acoesData
    .filter(r => categoria === "Todas as Categorias" || r.categoria === categoria)
    .filter(r => !search || r.utilizador.toLowerCase().includes(search.toLowerCase()) || r.descricao.toLowerCase().includes(search.toLowerCase()));
