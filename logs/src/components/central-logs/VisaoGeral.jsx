...
import { Users, LogIn, FilePlus, Wrench, Activity, TrendingUp, TrendingDown } from "lucide-react";
import { statsCards, topCollaborators, topObras, topPages } from "@/lib/logsData";
...
function RankedListBlock({ title, allItems, columns, metricOptions }) {
