...
import { subempreiteirosData } from "@/lib/logsData";
...
export default function SubempreiteirosSection() {
  ...
  const maxVal = Math.max(...subempreiteirosData.map(x => x[metric]));
    ...
    <div className="bg-card rounded-xl border border-border/60 overflow-hidden">
      ...
      <div className="overflow-x-auto">
        <Table>
          ...
          <TableBody>
            {items.map((row, i) => {
              const badge = atividadeBadge[row.atividade];
